...
const App = () => {
    ...
    return(
         <Container className="p-5"> 
                <div>
                    <button className="choose" onClick={() =>setIsCross(true)}>Cross</button> 
                    <button className="choose" onClick={() =>setIsCross(false)}>Circle</button>
...
// npm i reactstrap react-toastify
